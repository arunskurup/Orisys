...
function changesub()
{
  ...
  const category_id = selectTag.options;
  var category = category_id[selectTag.selectedIndex].value;

     console.log(category);

        var ajaxurl = baseurl + "Admin/Subcategory/find/"+category;
    var data = {  };

    globalAjax("POST", data, ajaxurl, successResponse, error);
